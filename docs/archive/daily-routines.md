...
<img style="width:100%;" sizing="cover" src="./images/project/daily-routines.jpg" />

This is an ongoing and unfinished project that I wish to give more attention in the future.
It is a GPS data visualization application that takes advantage of WebGL and shaders to provide extremely fast and interactive filtering of massive GPS datasets.
